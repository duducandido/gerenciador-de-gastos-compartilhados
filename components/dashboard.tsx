...
import { createSavingsGoal, contributeToSavingsGoal, updateHouseholdSettings, updateProfileAvatar } from '@/app/actions/household'
import {
  ArrowDownLeft,
  ArrowUpRight,
  Bell,
...
export default function Page({ initialProfileName, initialHouseholdName, initialAvatarImage, initialSavings }: DashboardProps) {
